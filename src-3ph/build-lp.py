...
duplicates_log = project_root / 'process-data-duplicates.log'
errors_log = project_root / 'process-data-error.log'
...
# --- Load meter metadata ---
meter_metadata = {}
with open(meter_list_file, 'r', encoding='utf-8-sig') as f:
                    ...
                    if row and len(row) >= 4:
                        try:
                            ...
                            if dt in data_by_time:
                                ...
                                with open(duplicates_log, 'a', encoding='utf-8') as dlog:
                                    dlog.write(f"{meter},{dt},{file.resolve()},{log_type} ROW: {row}\n")
                            else:
                                data_by_time[dt] = row

                        except ValueError:
                            with open(errors_log, 'a', encoding='utf-8') as elog:
